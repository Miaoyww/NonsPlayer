<script lang="ts">
  ...
  // 临时数据
  const dummySongs = [
    { songName: "僕の戦争", artist: "神聖かまってちゃん", duration: "3:30" },
    { songName: "The Rumbling", artist: "SiM", duration: "3:40" },
    { songName: "紅蓮華", artist: "LiSA", duration: "3:56" },
    { songName: "廻廻奇譚", artist: "Eve", duration: "3:38" },
    { songName: "残酷な天使のテーゼ", artist: "高橋洋子", duration: "4:06" },
    { songName: "Again", artist: "YUI", duration: "4:15" },
    { songName: "シルエット", artist: "KANA-BOON", duration: "4:01" },
    { songName: "R★O★C★K★S", artist: "HOUND DOG", duration: "3:39" },
  ];
</script>
